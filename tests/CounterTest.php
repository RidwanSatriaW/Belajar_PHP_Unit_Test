...
//Class asser bisa untuk mengecek kondisi, tidak perlu if else
...
class CounterTest extends TestCase
{
    ...
    //depends artinya melanjutkan dari test sebelumnya, di
    /**
     * @depends testFirst
     */
    //melanjutkan dari testFirst
    ...
    //dieksekusi setiap kali tes function dilakukan, bukan sekali saja
    protected function tearDown(): void
    {
        echo "Tear Down" . PHP_EOL;
    }
//melakukan Teardown dengan nama function sendiri
    /**
     * @after
     */
